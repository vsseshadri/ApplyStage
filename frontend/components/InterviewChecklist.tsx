...
const TOPIC_POOLS: TopicPool = {
  ...
  payroll: {
    technical_screen: {
      senior: [
        'Review end-to-end bi-weekly payroll processing for multi-state workforce',
        'Prepare to discuss UKG experience and working knowledge of ADP systems',
        'Document pay calculations, validations, audits, and finalization processes',
        'Review payroll accuracy: earnings, deductions, garnishments, taxes, retro adjustments, leave pay',
        'Prepare examples of off-cycle payments and special payroll situations',
        'Document payroll reconciliations and variance resolution with Finance',
        'Review payroll tax and compliance: state/local wage and hour rules, reciprocal agreements',
        'Prepare to discuss new withholding requirements and agency updates implementation',
        'Document pre-payroll and post-payroll audits: timecard review, exception reporting',
        'Review pay rate checks and termination pay compliance by state',
        'Prepare examples of payroll reports and dashboards for leadership',
        'Document SOPs, internal controls, and audit compliance',
      ],
      mid: [
        'Review bi-weekly payroll processing experience: calculations, validations, audits',
        'Prepare to discuss payroll systems: UKG, ADP, Workday, or similar',
        'Document handling earnings, deductions, garnishments, and tax withholdings',
        'Review reconciliation processes and resolving payroll variances',
        'Prepare examples of employee payroll data integrity management',
        'Document timecard review and exception reporting experience',
        'Review state-specific payroll compliance knowledge',
        'Prepare to discuss partnering with HR, Benefits, and field teams',
        'Document creating and maintaining payroll reports',
        'Review year-end activities: W-2 support, audits, payroll calendar',
      ],
      junior: [
        'Review payroll fundamentals: pay calculations, deductions, tax withholding basics',
        'Prepare to discuss any coursework in accounting, HR, or payroll',
        'Document Excel proficiency for payroll analysis and reporting',
        'Review basic payroll concepts: gross pay, net pay, FICA, federal/state taxes',
        'Prepare examples from internships or part-time work involving payroll or accounting',
        'Document attention to detail and accuracy in data entry',
        'Review what payroll specialists do day-to-day',
        'Prepare questions about payroll systems training (UKG, ADP)',
        'Document any relevant coursework or certifications (FPC, CPP)',
        'Review the company size and payroll complexity',
      ],
    },
    behavioural: {
      senior: [
        'Prepare STAR stories about resolving complex payroll issues quickly and professionally',
        'Document partnering with HR, Finance, and field leaders on payroll matters',
        'Review handling confidential payroll information with discretion',
        'Prepare examples of continuous improvement initiatives for payroll workflows',
        'Document system enhancements, testing, and implementations you\'ve led',
        'Review handling high-volume payroll during peak periods (year-end, acquisitions)',
        'Prepare story about catching and correcting payroll errors before they impacted employees',
        'Document translating compliance changes into system setup and process updates',
        'Review collaborating across teams: HR, Benefits, Finance, field operations',
        'Prepare examples of building controls and audit-ready documentation',
      ],
      mid: [
        'Prepare STAR stories demonstrating accuracy and attention to detail in payroll',
        'Document meeting bi-weekly payroll deadlines consistently',
        'Review examples of resolving employee payroll questions with professionalism',
        'Prepare story about learning a new payroll system or process quickly',
        'Document teamwork examples with HR, Benefits, and Finance partners',
        'Review handling multiple priorities during payroll close periods',
        'Prepare to discuss your career goals in payroll and HR operations',
        'Document process improvements you\'ve suggested or implemented',
      ],
      junior: [
        'Prepare STAR stories from coursework, internships, or part-time accounting/HR work',
        'Document attention to detail: catching errors, accuracy in data entry',
        'Review examples of working with spreadsheets and numerical data',
        'Prepare story about learning something new quickly in a professional setting',
        'Document teamwork and collaboration examples',
        'Review handling deadlines and prioritizing tasks',
        'Prepare to discuss your interest in payroll and HR operations',
        'Document any relevant coursework in accounting, HR, or business',
      ],
    },
    recruiter_screening: {
      senior: [
        'Prepare career summary highlighting multi-state payroll processing experience',
        'Document your UKG and ADP system expertise',
        'Review salary expectations for senior payroll specialist roles',
        'Prepare to discuss payroll compliance experience: federal, state, local requirements',
        'Document your can-do mindset and service-oriented approach',
        'Prepare questions about payroll volume, system environment, and team structure',
        'Review the company\'s multi-state presence and payroll complexity',
        'Document your availability and any certifications (CPP, FPC)',
      ],
      mid: [
        'Prepare career overview: payroll experience, systems used, progression',
        'Research company: size, multi-state presence, payroll complexity',
        'Review market rate for payroll specialists in your area',
        'Prepare reasons for interest in this specific role and company',
        'Document your experience with UKG, ADP, or similar payroll systems',
        'Prepare questions about bi-weekly payroll cycle and team collaboration',
        'Review job description and map your experience to requirements',
        'Document any relevant certifications or training',
      ],
      junior: [
        'Prepare introduction: education, relevant coursework in accounting or HR',
        'Research the company: size, industry, payroll complexity',
        'Understand entry-level payroll specialist salary in your area',
        'Prepare specific reasons for interest in payroll career',
        'Document your Excel skills and attention to detail',
        'Prepare questions about training on UKG/ADP and career growth path',
        'Review what payroll specialists do and why it interests you',
        'Document any relevant experience: accounting, HR, data entry',
      ],
    },
    phone_screen: {
      senior: [
        'Review your experience with end-to-end bi-weekly payroll for multi-state workforce',
        'Prepare to discuss UKG and ADP system proficiency in detail',
        'Document your approach to payroll accuracy and compliance',
        'Prepare STAR stories about resolving complex payroll issues',
        'Review your experience with payroll tax compliance across multiple states',
        'Prepare questions about current payroll challenges and system environment',
        'Document experience with year-end activities: W-2s, audits, calendar planning',
        'Prepare to discuss continuous improvement initiatives you\'ve implemented',
      ],
      mid: [
        'Review your payroll processing responsibilities: calculations, validations, audits',
        'Prepare to discuss your most challenging payroll issue and how you resolved it',
        'Document your UKG, ADP, or other payroll system proficiency',
        'Prepare STAR stories demonstrating accuracy and deadline management',
        'Review payroll reconciliation and variance resolution experience',
        'Prepare questions about typical bi-weekly payroll cycle',
        'Document your experience partnering with HR and Finance',
        'Prepare to discuss your career goals in payroll operations',
      ],
      junior: [
        'Review payroll concepts from coursework or research',
        'Prepare to discuss relevant projects, internships, or part-time experience',
        'Document your Excel and data analysis skills',
        'Prepare STAR stories showing attention to detail and learning ability',
        'Review what payroll specialists do: processing, compliance, reporting',
        'Prepare questions about UKG/ADP training and mentorship',
        'Document any relevant accounting or HR experience',
        'Prepare to discuss your interest in payroll career path',
      ],
    },
    hiring_manager: {
      senior: [
        'Research the hiring manager: their background in payroll/HR operations',
        'Prepare a 30-60-90 day plan for ramping up on their UKG/ADP systems and processes',
        'Document your approach to building partnerships with HR, Finance, and field teams',
        'Prepare to discuss balancing accuracy with tight bi-weekly deadlines',
        'Review specific challenges: multi-state compliance, system enhancements, year-end',
        'Prepare questions about payroll volume, team structure, and success metrics',
        'Document your experience with SOPs, internal controls, and audit readiness',
        'Prepare to discuss your collaborative, service-oriented approach',
      ],
      mid: [
        'Research the hiring manager and understand the payroll team structure',
        'Prepare to discuss how you\'d learn their UKG/ADP systems and payroll processes',
        'Document your experience with similar payroll volume or complexity',
        'Prepare questions about bi-weekly cycle, peak periods, and team collaboration',
        'Review what success looks like: accuracy, timeliness, employee satisfaction',
        'Prepare to discuss your working style and attention to detail',
        'Document your career goals in payroll and HR operations',
        'Prepare questions about year-end activities and professional development',
      ],
      junior: [
        'Research the hiring manager on LinkedIn',
        'Prepare to discuss your approach to learning payroll systems and compliance',
        'Document your eagerness to learn and handle detailed, numerical work',
        'Prepare questions about training program, feedback, and mentorship',
        'Review what you\'d likely do in your first few months',
        'Prepare to discuss your interest in payroll career path',
        'Document your reliability, accuracy, and attention to detail',
        'Prepare questions about growth path: specialist to senior to manager',
      ],
    },
    final_round: {
      senior: [
        'Prepare for deeper discussions on multi-state payroll compliance and strategy',
        'Review your experience with payroll system implementations and enhancements',
        'Document your approach to building controls and audit-ready documentation',
        'Prepare to discuss scenarios: compliance changes, system issues, employee disputes',
        'Review compensation expectations and any flexibility needed',
        'Prepare questions about organizational changes and payroll roadmap',
        'Document your experience with year-end activities and W-2 processing',
        'Prepare to discuss long-term career goals in payroll/HR operations leadership',
      ],
      mid: [
        'Review all previous interview topics for deeper follow-up',
        'Prepare to meet additional team members: HR, Finance, field operations',
        'Document questions about team dynamics and collaboration',
        'Prepare to discuss specific scenarios: payroll errors, compliance issues, tight deadlines',
        'Review salary expectations with market data',
        'Prepare to express strong interest and ask about next steps',
        'Document your decision factors and timeline',
        'Prepare questions about growth into senior payroll roles',
      ],
      junior: [
        'Review fundamentals discussed in previous interviews',
        'Prepare to meet additional team members',
        'Document your enthusiasm for payroll career opportunity',
        'Prepare questions about day-to-day life and team culture',
        'Review entry-level payroll specialist salary expectations',
        'Prepare to express commitment and interest in learning',
        'Document your availability to start',
        'Prepare questions about training timeline and first responsibilities',
      ],
    },
  },
