...
const TOPIC_POOLS: TopicPool = {
  ...
  operations: {
    technical_screen: {
      senior: [
        'Review inventory management systems: WMS, ERP modules, cycle counting, ABC analysis',
        'Prepare to discuss demand forecasting methods: moving average, exponential smoothing, seasonal adjustments',
        'Document experience with inventory optimization: safety stock calculations, reorder points, EOQ',
        'Review supply chain analytics: fill rates, inventory turns, OTIF, carrying costs',
        'Prepare examples of process improvements: cycle time reduction, accuracy improvement',
        'Document your experience with supplier management and vendor scorecards',
        'Review lean/Six Sigma methodologies: waste reduction, process mapping, root cause analysis',
        'Prepare to discuss inventory accuracy initiatives and their business impact',
        'Document experience with distribution network optimization',
        'Review your approach to managing seasonal demand and promotional inventory',
      ],
      mid: [
        'Review inventory fundamentals: FIFO/LIFO, carrying costs, stockout costs, turnover',
        'Prepare to discuss your experience with inventory systems: SAP MM, Oracle, NetSuite',
        'Document cycle counting procedures and reconciliation processes',
        'Review demand planning basics: forecasting inputs, accuracy measurement',
        'Prepare examples of resolving inventory discrepancies or variances',
        'Document your Excel skills for inventory analysis: pivot tables, VLOOKUP, data analysis',
        'Review receiving, put-away, and picking processes',
        'Prepare to discuss your experience with physical inventories',
        'Document KPIs you\'ve tracked: accuracy, turns, fill rate, obsolescence',
        'Review your experience working with purchasing and sales teams',
      ],
      junior: [
        'Review inventory management basics: what is inventory, why it matters, key metrics',
        'Prepare to discuss your coursework in operations, supply chain, or logistics',
        'Document Excel proficiency: basic formulas, sorting, filtering, pivot tables',
        'Review basic inventory concepts: SKU, UOM, lot/serial tracking',
        'Prepare examples from internships, projects, or part-time work',
        'Document your understanding of warehouse operations',
        'Review what inventory analysts do day-to-day',
        'Prepare questions about training and systems you\'ll learn',
        'Document your attention to detail with specific examples',
        'Review the company\'s products and supply chain if possible',
      ],
    },
    behavioural: {
      senior: [
        'Prepare STAR stories about inventory optimization with quantified savings',
        'Document cross-functional collaboration: purchasing, sales, finance, operations',
        'Review examples of process improvement initiatives you\'ve led',
        'Prepare story about resolving a major inventory discrepancy or write-off',
        'Document your experience training or mentoring team members',
        'Review handling conflicting priorities: service levels vs inventory costs',
        'Prepare examples of data-driven decision making in inventory management',
        'Document your approach to working with suppliers on inventory issues',
      ],
      mid: [
        'Prepare STAR stories demonstrating analytical and problem-solving skills',
        'Document meeting deadlines during busy periods: month-end, physical inventory',
        'Review examples of catching and resolving data errors or discrepancies',
        'Prepare story about learning a new system or process quickly',
        'Document teamwork examples with warehouse, purchasing, or sales teams',
        'Review handling high-volume, detail-oriented work',
        'Prepare to discuss your career goals in supply chain/operations',
        'Document process improvement suggestions you\'ve made',
      ],
      junior: [
        'Prepare STAR stories from coursework, internships, or part-time jobs',
        'Document attention to detail: catching errors, accuracy in work',
        'Review examples of working with data and spreadsheets',
        'Prepare story about learning something new quickly',
        'Document teamwork and collaboration examples',
        'Review handling multiple tasks and prioritizing',
        'Prepare to discuss your interest in supply chain/inventory management',
        'Document any relevant coursework or certifications (APICS, etc.)',
      ],
    },
    recruiter_screening: {
      senior: [
        'Prepare career summary highlighting supply chain and inventory accomplishments',
        'Document your experience with major ERP/WMS systems',
        'Review salary expectations for senior inventory/supply chain roles',
        'Prepare to discuss certifications: APICS CPIM/CSCP, Six Sigma, etc.',
        'Document your industry experience and why this company interests you',
        'Prepare questions about team structure, systems, and current challenges',
        'Review the company\'s supply chain and distribution model',
        'Document your availability and notice period',
      ],
      mid: [
        'Prepare career overview: education, experience, progression in inventory/ops',
        'Research company: products, distribution, supply chain complexity',
        'Review market rate for inventory analyst roles in your area',
        'Prepare reasons for interest in this specific role and company',
        'Document your experience with inventory systems and Excel',
        'Prepare questions about team size, systems used, and day-to-day work',
        'Review job description and map your experience to requirements',
        'Document any relevant certifications or training',
      ],
      junior: [
        'Prepare introduction: degree, relevant coursework, any supply chain interest',
        'Research the company: products, industry, distribution model',
        'Understand entry-level inventory/operations analyst salary',
        'Prepare specific reasons for interest in inventory/supply chain',
        'Document your Excel and analytical skills',
        'Prepare questions about training, systems, and career growth',
        'Review what inventory analysts do and why it interests you',
        'Document any relevant internship or work experience',
      ],
    },
    phone_screen: {
      senior: [
        'Review your experience with inventory optimization and quantify the impact',
        'Prepare to discuss demand forecasting methods you\'ve used',
        'Document your approach to reducing inventory while maintaining service levels',
        'Prepare STAR stories about process improvements and cost savings',
        'Review your ERP/WMS expertise and reporting capabilities',
        'Prepare questions about current inventory challenges and KPIs',
        'Document experience with supplier collaboration on inventory',
        'Prepare to discuss your management or leadership experience',
      ],
      mid: [
        'Review your daily responsibilities in inventory management',
        'Prepare to discuss your most challenging inventory issue and resolution',
        'Document your Excel and system proficiency',
        'Prepare STAR stories demonstrating analytical skills and accuracy',
        'Review inventory metrics you\'ve tracked and reported',
        'Prepare questions about typical work cycle and peak periods',
        'Document your experience with cycle counts and reconciliation',
        'Prepare to discuss your career goals in supply chain',
      ],
      junior: [
        'Review inventory and supply chain concepts from coursework',
        'Prepare to discuss relevant projects or case studies',
        'Document your Excel and data analysis skills',
        'Prepare STAR stories showing attention to detail and learning ability',
        'Review what inventory analysts do day-to-day',
        'Prepare questions about training and mentorship',
        'Document any relevant work or internship experience',
        'Prepare to discuss your interest in operations/supply chain',
      ],
    },
    hiring_manager: {
      senior: [
        'Research the hiring manager: their background, team structure',
        'Prepare a 30-60-90 day plan for ramping up on their inventory systems',
        'Document your approach to building relationships with operations and purchasing',
        'Prepare to discuss how you handle inventory trade-offs: cost vs service',
        'Review specific challenges this company might face (seasonal, perishable, etc.)',
        'Prepare questions about performance metrics and success criteria',
        'Document your experience leading inventory initiatives',
        'Prepare to discuss your management style and team development',
      ],
      mid: [
        'Research the hiring manager and understand the team',
        'Prepare to discuss how you\'d learn their specific systems and processes',
        'Document your experience in similar industries or inventory environments',
        'Prepare questions about day-to-day responsibilities and challenges',
        'Review what success looks like after 6-12 months',
        'Prepare to discuss your working style and collaboration approach',
        'Document your career goals and how this role fits',
        'Prepare questions about team culture and busy periods',
      ],
      junior: [
        'Research the hiring manager on LinkedIn',
        'Prepare to discuss your approach to learning new systems',
        'Document your eagerness to learn and handle detailed work',
        'Prepare questions about training, feedback, and mentorship',
        'Review what you\'d likely do in your first few months',
        'Prepare to discuss your career interests in supply chain',
        'Document your reliability and attention to detail',
        'Prepare questions about growth opportunities',
      ],
    },
    final_round: {
      senior: [
        'Prepare for deeper discussions on inventory strategy and optimization',
        'Review your experience presenting to leadership or cross-functional teams',
        'Document your vision for improving inventory performance',
        'Prepare to discuss relationships with operations, purchasing, sales, finance',
        'Review compensation expectations and negotiation points',
        'Prepare thoughtful questions about company growth and supply chain challenges',
        'Document your approach to change management and system implementations',
        'Prepare to discuss long-term career goals and fit',
      ],
      mid: [
        'Review all previous interview topics for deeper follow-up',
        'Prepare to meet additional team members or cross-functional partners',
        'Document questions about team dynamics and collaboration',
        'Prepare to discuss specific scenarios: physical inventory, discrepancies',
        'Review salary expectations with market data',
        'Prepare to express strong interest and ask about next steps',
        'Document your decision factors and timeline',
        'Prepare questions about growth and development opportunities',
      ],
      junior: [
        'Review fundamentals discussed in previous interviews',
        'Prepare to meet additional team members',
        'Document your enthusiasm for the opportunity',
        'Prepare questions about day-to-day life and culture',
        'Review entry-level salary expectations',
        'Prepare to express commitment and interest',
        'Document your availability to start',
        'Prepare questions about first projects and training',
      ],
    },
  },
  ...
  admin: {
    ...
    behavioural: {
      ...
      junior: [
        ...
        'Prepare story about learning a new skill or system quickly',
        'Document customer service or front-facing experience',
        'Review examples of being reliable and dependable',
        'Prepare to discuss your interest in administrative support',
        'Document teamwork and collaboration examples',
      ],
    },
    recruiter_screening: {
      senior: [
        'Prepare career summary highlighting executive support experience',
        'Document types of executives supported: C-suite, VP level, department heads',
        'Review salary expectations for senior administrative roles in your market',
        'Prepare to discuss your technology skills: Office Suite, scheduling tools, expense systems',
        'Document your reasons for seeking this opportunity',
        'Prepare questions about the executive(s) you\'d support and company culture',
        'Review the company and executive team on LinkedIn',
        'Document your availability and schedule flexibility',
      ],
      mid: [
        'Prepare career overview: administrative experience, progression, key skills',
        'Research company: size, industry, culture, executive team',
        'Review market rate for administrative assistants in your area',
        'Prepare reasons for interest in this company and role',
        'Document your Microsoft Office proficiency and other technical skills',
        'Prepare questions about team structure, duties, and who you\'d support',
        'Review job description and map your experience to requirements',
      ...
      junior: [
        ...
        'Prepare questions about training, responsibilities, and growth',
    ...
    phone_screen: {
      senior: [
        'Review your experience supporting executives: calendar, travel, communications',
        'Prepare to discuss complex scheduling across time zones and conflicting priorities',
        'Document examples of managing confidential information professionally',
        'Prepare STAR stories about anticipating needs and proactive problem-solving',
        'Review your event planning and coordination experience',
        'Prepare questions about the executive\'s working style and expectations',
        'Document your approach to handling urgent requests and reprioritization',
        'Prepare to discuss your communication style with executives and their stakeholders',
      ],
      mid: [
        'Review your administrative experience: scheduling, correspondence, office management',
        'Prepare to discuss your most challenging administrative situation and how you handled it',
        'Document your Microsoft Office and technology proficiency',
        'Prepare STAR stories demonstrating organization and reliability',
        'Review your experience with travel arrangements and expense reporting',
      ...
      junior: [
        ...
        'Prepare questions about training and what you\'d learn',
    ...
    hiring_manager: {
      senior: [
        'Research the hiring manager and executive(s) you\'d support',
        'Prepare a 30-60-90 day plan for learning preferences and establishing trust',
        'Document your approach to building a partnership with executives',
        'Prepare to discuss how you handle conflicting demands on your executive\'s time',
        'Review specific challenges this role might face (travel-heavy, high volume, etc.)',
        'Prepare questions about communication preferences and working style',
        'Document your experience managing sensitive or confidential matters',
        'Prepare to discuss how you stay organized with multiple priorities',
      ],
      mid: [
        'Research the hiring manager and understand the team structure',
        'Prepare to discuss how you\'d ramp up and learn their processes',
        'Document your experience supporting similar roles or industries',
        'Prepare questions about day-to-day responsibilities and expectations',
        'Review what success looks like in this role',
        'Prepare to discuss your working style and how you stay organized',
        'Document your career goals and how this role fits',
      ...
      junior: [
        ...
        'Prepare questions about growth and career development',
      ],
    },
    final_round: {
      senior: [
        'Prepare for deeper discussions about supporting specific executives',
        'Review your experience handling high-stakes situations or events',
        'Document your approach to building trust and partnership with executives',
        'Prepare to discuss hypothetical scenarios: calendar conflicts, urgent requests',
        'Review compensation expectations and any flexibility needed',
        'Prepare thoughtful questions about company culture and team dynamics',
        'Document your long-term career goals in executive support',
        'Prepare to meet additional stakeholders and express genuine enthusiasm',
      ],
      mid: [
        'Review all previous interview topics for follow-up questions',
        'Prepare to meet additional team members or executives',
        'Document questions about team dynamics and working relationships',
        'Prepare to discuss specific scenarios: scheduling conflicts, difficult situations',
        'Review salary expectations with market data',
        'Prepare to express strong interest and ask about next steps',
        'Document your decision factors and timeline',
