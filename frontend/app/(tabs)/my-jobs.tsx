...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, RefreshControl, ActivityIndicator, Modal, TextInput, KeyboardAvoidingView, Platform, Alert, Dimensions, Linking, Animated } from 'react-native';
...
export default function MyJobsScreen() {
  ...
  // Helper function to parse date from various CSV/Excel formats and convert to ISO format for API
  ...
  const openEditModal = (job: any) => {
    ...
    setFormData({
      ...
      min_salary: job.salary_range.min > 0 ? formatSalaryWithCommas(job.salary_range.min.toString()) : '',
      max_salary: job.salary_range.max > 0 ? formatSalaryWithCommas(job.salary_range.max.toString()) : '',
