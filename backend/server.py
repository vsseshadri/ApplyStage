    ...
    try:
        ...
        for user_doc in users:
            try:
                ...
                weekly_jobs = await db.job_applications.find(
                    {
                        "user_id": user_id,
                        "date_applied": {"$gte": week_start}
                    },
